...
# configurables
K = 7                     # number of UEs
tau_p = 3              # length of pilot sequences
# configurables
...
save_dataset_to_csv('dataset_optimal_7_3_p_20m2.csv', allAPposition_opt, allUEpositions_opt, allBest_pilot_index_opt, allSystem_NMSE_opt, allUEs_NMSE_opt, mode='optimal')
print('Optimal assignments saved.')

# Save dataset with all results for random
save_dataset_to_csv('dataset_random_7_3_p_20m2.csv', allAPposition_rand, allUEpositions_rand, allBest_pilot_index_rand, allSystem_NMSE_rand, allUEs_NMSE_rand,mode='random')
